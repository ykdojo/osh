...
class CursesShortcutHandler:
    ...
    def show_recording_done_screen(self):
        ...
        content = [
            ...
            "", 
            "Transcribing...",
            "When complete, transcription will be sent to cursor and copied to clipboard."
        ]
    ...
    def show_transcription(self):
        """Display mock transcription results and type at cursor automatically"""
        ...
        content = [
            ...
            transcript,
            "",
            "Transcription sent to cursor and copied to clipboard!"
        ]
        self.display_screen_template("RECORDING DONE!", content)
